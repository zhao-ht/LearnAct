...
You can also use "Think" to plan what to do.
...
Think: To solve the task, I need to put b2 on b3, and b1 on b2. First, I need to put b2 on b3.
Observation: Ok.
Action: Pickup('b2')
...
The robot has four actions: Pickup, Putdown, Stack, and Unstack. The domain assumes a world where there are a set of blocks that can be stacked on top of each other, an arm that can hold one block at a time, and a table where blocks can be placed.
    ...
    You can also use 'Think' to plan what to do next.
""",
...
Think: To solve the task, I need to get ingredient1 and ingredient3 into a shaker. First, I need to get ingredient3 into shaker1 by shot1.
Observation: Ok.
...
Think: I need to get ingredient1 into shaker1 by shot1.
Observation: Ok.
...
Observation: You are holding right.
Think: I can shake shaker1 to get the cocktail1, then pour it to Shot1.
Observation: Ok.
...
Think: To solve the task, I need to carry ball1, ball2 and ball3 from rooma to roomb. First, I need to carry ball1 and ball2 from rooma to toomb.
Observation: Ok.
...
Think: I need to get back to rooma then carry ball3 from rooma to toomb.
Observation: Ok.
...
Think: To solve the task, first I need to get the wrench from the boot to loosen the nuts1 of the-hub1.
Observation: Ok.
...
Think: I need to get the jack to jack up the-hub1, then undo nuts1 to the-hub1.
Observation: Ok.
...
Think: I need to remove w1 from the-hub1 and put w1 to boot.
Observation: Ok.
